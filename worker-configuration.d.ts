/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b463beaa9856b05d8a547ab08c37bb7e)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "USE_API" | "FUEL_FINDER_CLIENT_SECRET" | "FUEL_FINDER_CLIENT_ID" | "OPENROUTER_API_KEY">> {}
}
declare module "*.md" {
	const value: string;
