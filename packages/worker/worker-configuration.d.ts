/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5b3cedbdf93e2c948604ed97762463d)
// Runtime types generated with workerd@1.20260409.1 2026-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PetrolBabyObject";
	}
	interface Env {
		USE_API: string;
		...
		PETROL_BABY_OBJECT: DurableObjectNamespace<import("./src/index").PetrolBabyObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "USE_API" | "FUEL_FINDER_CLIENT_ID" | "FUEL_FINDER_CLIENT_SECRET" | "OPENROUTER_API_KEY">> {}
}
declare module "*.md" {
	const value: string;
